...
Решатели (OpenGeoSys, MATLAB, FLAC/PLAXIS, gprMax …) — будущие адаптеры, а не носители мира.
...
Phase 1 (cloud) — только информация и архитектура: полный sweep корпуса, каталоги, провенанс, хронология,
дизайн WorldSpec, схемы, лёгкие тесты. Численные расчёты не выполнялись:
