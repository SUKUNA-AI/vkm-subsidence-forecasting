...
from .scenario_adapter_v2_1 import ModelDataBundle, make_dataset
from .scenario_boundary_v2_1 import verified_manifest, verified_payload, json_sha256
...
def load_frozen_folds(directory: str | Path, bundle, groups, config) -> tuple[Fold, ...]:
    ...
    from .scenario_boundary_v2_1 import file_sha256
