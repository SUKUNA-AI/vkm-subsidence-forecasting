...
слайдов Мусихина переходит в наблюдательную evidence со статусом **discovery-only**. Это единственные
численные наблюдения оседаний в PUBLIC-дереве. Выдавать их за временные ряды СКРУ-1 нельзя.
