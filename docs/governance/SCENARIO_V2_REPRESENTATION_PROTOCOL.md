# Scenario v2: model-facing representation protocol v1

**DRAFT — BLOCKED, NOT FROZEN.** Полная acceptance обнаружила расхождение elapsed
days в frozen tabular features. Решение пользователя требуется до фиксации этого
protocol. См. `docs/reports/SCENARIO_V2_ADAPTER_ACCEPTANCE_RU.md`.

Дата: 2026-09-24. Область: representation acceptance, без fit/predict/scoring моделей.
Data authority: commit `ffcf86972d31bd9f0dbd62d1265001f5c722e253`,
`data/scenario_simulation_v2/manifest.json` SHA256
