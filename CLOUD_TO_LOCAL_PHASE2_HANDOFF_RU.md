...
- **Каталог.** `borehole_catalog.csv` — 1111 строк.
  - Одна строка на скважину в контексте нумерации. Упоминания объединялись по правилам идентичности
    ...
    MEDIUM — 100. MEDIUM, как правило, — воспроизведение одного рисунка в разных книгах. Прежде чем использовать
    объединённую строку в 3D, проверьте уверенность идентичности.
